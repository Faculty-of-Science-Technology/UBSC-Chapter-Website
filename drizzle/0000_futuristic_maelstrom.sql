...
CREATE TABLE "Roles" (
	...
	"color" varchar(7) DEFAULT '#0284c7' NOT NULL,
...
CREATE TABLE "ThemeSettings" (
	...
	"sidebar_color" varchar(7) DEFAULT '#F3F4F6' NOT NULL,
	"link_color" varchar(7) DEFAULT '#3B82F6' NOT NULL,
	"button_color" varchar(7) DEFAULT '#3B82F6' NOT NULL,
	"success_color" varchar(7) DEFAULT '#10B981' NOT NULL,
	"warning_color" varchar(7) DEFAULT '#F59E0B' NOT NULL,
	"error_color" varchar(7) DEFAULT '#EF4444' NOT NULL,
	"logo_url" text,
	"favicon_url" text,
	"custom_css" text,
...
CREATE TABLE "Users" (
	...
	"__created_at__" date DEFAULT CURRENT_DATE NOT NULL,
...
ALTER TABLE "Posts" ADD CONSTRAINT "Posts_group_id_Groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."Groups"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ThemeSettings" ADD CONSTRAINT "ThemeSettings_created_by_Users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."Users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "UserRoles" ADD CONSTRAINT "UserRoles_assigned_by_Users_id_fk" FOREIGN KEY ("assigned_by") REFERENCES "public"."Users"("id") ON DELETE no action ON UPDATE no action;